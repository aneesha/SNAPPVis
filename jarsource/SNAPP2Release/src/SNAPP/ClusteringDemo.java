...
*/
	...
	public void start(Graph<Integer,Number> grp, Map<Integer,String> name) {
		setUpView(grp,name);
		/*
		InputStream is = ClusteringDemo.class.getResourceAsStream("images/zachary.net");
	...
	private void setUpView(Graph<Integer,Number> grp ,Map<Integer,String> name) {
        ...
        */
		...
		this.usernames = name;
        final AggregateLayout<Integer,Number> layout = new AggregateLayout<Integer,Number>(new FRLayout<Integer,Number>(grp));
